...
- Gestión de Cuentas y Autenticación: Los usuarios al momento de querer inicializarse en la plataforma deberan registrarse e iniciar sesion, para ello deberan brindar ciertos datos que la plataforma requerira, como una contraseña, correo electronico y nombre de usuario. Esto les permitira poder gestionar su perfil (El cual tendra la opcion de poder ser personalizado a traves de un avatar), acceder a la administracion de su club al momento que este lo cree e interactuar con el juego.
...
- Comportamientos de Jugadores: El sistema proveerá primitivas básicas. El usuario podrá crear sus propios comportamientos fuera del partido programando la lógica del script en código Python dentro de las reglas de la plataforma. Una vez iniciado el partido, el usuario no podrá crear ni editar código, pero sí tendrá permitido reasignar entre sus jugadores los comportamientos creados previamente.
...
- El sistema debe recibir y almacenar el codigo Python de los comportamientos asociados al usuario creador.
...
## Comportamiento del Sistema: Flujo Principal del Usuario 

- Registro e Inicio de Sesion: Un nuevo usuario debe registrarse en la plataforma antes de poder acceder a cualquier funcionalidad (ver Requisitos Funcionales para las condiciones de validez del registro). Una vez autenticado, el sistema lo redirige a su panel principal, donde encontrara un resumen de su club, su historial de partidos y las ligas en las que participara activamente.
